...
test_plan:
  current_focus:
    - "Добавить кнопку 'Выбери печатающего помошника'"
    - "Создать данные принтеров из CSV"
    - "Создать страницу выбора принтеров"
    - "Создать компоненты для принтеров"
    - "Добавить маршрутизацию для страницы принтеров"
  stuck_tasks: []
  test_all: true
