          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 border border-pink-200">
                ...
                <span className="text-sm font-medium text-gray-700">Trusted by Major Companies</span>
              </div>
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-lg">
                Save on maintenance costs and extend your printing equipment's service life with our comprehensive subscription services and expert repairs.
              </p>
            </div>
            ...
            <div className="pt-8 border-t border-gray-200">
              ...
              <div className="flex flex-wrap items-center gap-6 text-gray-400">
                <span className="font-semibold">Svyaznoy</span>
                <span className="font-semibold">SovcomBank</span>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl p-4 shadow-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="font-semibold text-gray-900">Quick Diagnosis</div>
